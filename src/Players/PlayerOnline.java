...
public abstract class PlayerOnline extends AnimatedSprite
{
	// ---------------------------------------------
	// VARIABLES
	// ---------------------------------------------
	...
	public PlayerOnline(float pX, float pY, VertexBufferObjectManager vbo, Camera camera, PhysicsWorld physicsWorld)
	{
		super(pX, pY, ResourcesManager.getInstance().playerOnline_region, vbo);
		mineColision = false;
		hasGreenKey = false;
		hasKey = false;
		canRun = false;
