...
public class BulletParticleSystem implements ParticleSystemFactory
{
    ...
    public SpriteParticleSystem build(Engine engine, float fontX, float fontY)
    {
		...
		particleSystem = new SpriteParticleSystem (circleParticleEmtitter, maxRate, minRate, maxParticles, ResourcesManager.getInstance().bullet.deepCopy(), vbom);
	    ...
	    particleSystem.addParticleInitializer(new VelocityParticleInitializer<Sprite>(0, 30, 0, 250));
