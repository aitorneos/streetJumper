...
public class RadialBlur extends Object
{
    ...
    public static RadialBlur getInstance()
    {
            return INSTANCE;
    }
   
   
    public static RadialBlurShaderProgram getShaderProgram()
    {         
            return RadialBlurShaderProgram.getInstance();
    }
