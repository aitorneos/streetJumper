 ...
 * (c) 2011 Zynga Inc.
 * 
 * @author Nicolas Gramlich && Modified by Aitor Arque Arnaiz 2014
		...
		public void onReceive(final Context pContext, final Intent pIntent) {
			...
			if (action.equals(BluetoothDevice.ACTION_FOUND)) {
				...
				if (device.getBondState() != BluetoothDevice.BOND_BONDED) {
					BluetoothDeviceDetection.this.mNewDevicesArrayAdapter.add(device.getName() + "\n" + device.getAddress());
				}
			} else if (action.equals(BluetoothAdapter.ACTION_DISCOVERY_FINISHED)) {
				BluetoothDeviceDetection.this.setProgressBarIndeterminateVisibility(false);
				BluetoothDeviceDetection.this.setTitle("Select a device to connect...");
				if (BluetoothDeviceDetection.this.mNewDevicesArrayAdapter.getCount() == 0) {
					BluetoothDeviceDetection.this.mNewDevicesArrayAdapter.add("No devices found!");
				}
			}
		}
	};
