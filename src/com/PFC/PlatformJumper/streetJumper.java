...
public class streetJumper extends BaseAugmentedRealityGameActivity implements IAccelerationListener, ServerMessageFlags, ClientMessageFlags
{
    ...
    public void playerLoad(int playerID, final float pX, final float pY)
    {
    	...
    	if (playerID == 0 && resourcesManager.getLevelComplete() == 1) resourcesManager.playerOnline_region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(resourcesManager.gameTextureAtlas, this, "player.png", 3, 1);
        if (playerID == 1 && resourcesManager.getLevelComplete() == 1) resourcesManager.playerOnline_region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(resourcesManager.gameTextureAtlas, this, "player2.png", 3, 1);
        if (playerID == 2 && resourcesManager.getLevelComplete() == 1) resourcesManager.playerOnline_region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(resourcesManager.gameTextureAtlas, this, "player3.png", 3, 1);
        if (playerID == 3 && resourcesManager.getLevelComplete() == 1) resourcesManager.playerOnline_region = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(resourcesManager.gameTextureAtlas, this, "player4.png", 3, 1);
